...
$translations = [
    "en" => [
        ...
        "page_title_dashboard" => "Client Dashboard | DevifyWeb",
        "page_title_admin_login" => "Admin Login | DevifyWeb",
        "page_title_admin_dashboard" => "Admin Dashboard | DevifyWeb",
        ...
        "request_error" => "Please provide the project name, budget, timeline, and details.",
        ...
        "dashboard_heading" => "Client Dashboard",
    ...
    "ar" => [
        ...
        "page_title_dashboard" => "لوحة تحكم العميل | ديفاي ويب",
        "page_title_admin_login" => "تسجيل دخول الإدارة | ديفاي ويب",
        "page_title_admin_dashboard" => "لوحة تحكم الإدارة | ديفاي ويب",
        ...
        "request_error" => "يرجى إدخال اسم المشروع والميزانية والجدول الزمني والتفاصيل.",
        ...
        "contact_success" => "شكرًا لك! تم إرسال رسالتك.",
        "contact_error" => "حدث خطأ. يرجى المحاولة مرة أخرى.",
        "dashboard_welcome" => "مرحبًا، {name}.",
        "dashboard_heading" => "لوحة تحكم العميل",
        ...
        "admin_dashboard_heading" => "لوحة تحكم الإدارة",
